      ...
      <div className="container">
        <div className="flex flex-wrap -mx-3 -mb-6 text-center">
          <div
            ...
            data-wow-delay=".3s"
          >
            <div data-aos="fade-up" className="p-12 bg-white shadow rounded">
              ...
              <p className="text-sm text-blueGray-400 leading-relaxed">
                Project initiation ensures that you lay a strong foundation for
                a new project in your company our team.
              </p>
            </div>
          </div>
          <div
